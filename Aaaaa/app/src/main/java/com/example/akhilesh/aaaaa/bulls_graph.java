...
public class bulls_graph extends Fragment {

    View myView;
    LineChart lineChart;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    myView = inflater.inflate(R.layout.bulls_stats, container, false);
        lineChart = (LineChart) myView.findViewById(R.id.bull_chart);
        ArrayList<Entry> lineEntries;
        lineEntries = new ArrayList<Entry>();
        lineEntries.add(new Entry(0, 10));
        lineEntries.add(new Entry(1, 16));
        lineEntries.add(new Entry(2, 13));
